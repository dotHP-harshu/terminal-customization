...
export interface PROMPTS_INTERFACE {
  id: string;
  name: string;
  tag: string;
  tagClass: string;
...
export const PROMPTS: PROMPTS_INTERFACE[] = [
  {
    id: "1-modern",
    name: "Modern Dev",
    tag: "Full-featured",
    ...
    preview: (
      <div>
        <div>
          ...
          <span className="c-nerd"> {"\u{F08C7}"} </span>
          <span className="c-cyan">harsh@DESKTOP</span>
        </div>
        <div>
          <span className="c-muted">|</span>
        </div>
        <div>
          <span className="c-muted">├─</span>
          <span className="c-nerd"> {"\u{F024B}"} </span>
          <span className="c-path">~\Projects\SchoolFlow</span>
        </div>
        <div>
          <span className="c-muted">├─</span>
          <span className="c-nerd"> {"\u{F02DA}"} </span>
          <span className="c-yellow">main</span>{" "}
          <span className="c-green">v</span>
        </div>
        <div>
          <span className="c-muted">├─</span>
          <span className="c-nerd"> {"\u{F0399}"} v24.2.0</span>
        </div>
        <div>
          <span className="c-muted">├─</span>
          <span className="c-nerd"> {"\u{F0320}"} 3.13</span>
        </div>
        <div>
          <span className="c-muted">├─</span>
          <span className="c-nerd"> {"\u{F035B}"} 12ms</span>
        </div>
        <div>
          <span className="c-muted">|</span>
        </div>
        <div>
          <span className="c-muted">╰─</span>
          <span className="c-green">{"\u{F054A}"} </span>
        </div>
      </div>
    ),
    file: "1-modern.ps1",
  },
  {
    ...
    preview: (
      <div>
        ...
        <div>
          <span className="c-muted">├─[</span>
          <span className="c-path">~/SchoolFlow</span>
          <span className="c-muted">]</span>
        </div>
        <div>
          <span className="c-muted">╰─[</span>
          <span className="c-magenta">git:</span>{" "}
          <span className="c-yellow">main</span>{" "}
          <span className="c-green">v</span>
          <span className="c-muted">]</span>
        </div>
  ...
  },
  {
    ...
    preview: (
      <div>
        <div>
          <span className="c-nerd"> {"\u{F08C7} "}</span>{" "}
          <span className="c-cyan">Harsh</span>
        </div>
        <div>
          <span className="c-nerd"> {"\u{F024B} "}</span>{" "}
          <span className="c-path">SchoolFlow</span>
  ...
  },
  {
    ...
    preview: (
      <div>
        ...
        <div>
          <span className="c-muted">CPU 12% RAM 8.2 GB {"\u{F0579} "}82%</span>
        </div>
  ...
  },
  {
    ...
    preview: (
      <div>
        ...
        <div>
          <span className="c-muted">├─</span>
          <span className="c-nerd"> {"\u{F035B}"} 5ms</span>
        </div>
        <div>
          <span className="c-muted">|</span>
        </div>
  ...
  },
  {
    ...
    preview: (
      <div>
        <div>
          <span className="c-nerd">
            {"\u{25e2}\u{2588}\u{2588}"}{" "}
          </span>
          <span className="c-blue">USER</span>
          <span className="c-nerd">
            {" "}
            {"\u{2588}\u{2588}\u{25e3}"}
          </span>
        </div>
  ...
  },
  {
    ...
    preview: (
      <div>
        <div>
          <span className="c-cyan">Harsh</span> at
          <span className="c-path">SchoolFlow</span>
        </div>
  ...
  },
  {
    ...
    preview: (
      <div>
        <div>
          {" "}
          <span className="c-green">SYSTEM ONLINE</span>
        </div>

        <div>
          <span className="c-green">USER</span>
          <span className="c-muted">........</span>
          <span className="c-green">harsh</span>
        </div>
        <div>
          <span className="c-green">PROJECT</span>
          <span className="c-muted">.....</span>
          <span className="c-green">SchoolFlow</span>
        </div>
        <div>
          <span className="c-green">BRANCH</span>
          <span className="c-muted">......</span>
          <span className="c-green">main</span>
        </div>
    ...
    preview: (
      <div>
        ...
        <div>
          <span className="c-muted">├─</span>
          <span className="c-nerd"> {"\u{F024B}"} </span>
          <span className="c-path">D:\Projects\SchoolFlow</span>
        </div>
        <div>
          <span className="c-muted">├─</span>{" "}
          <span className="c-yellow">main</span>{" "}
        ...
        <div>
          <span className="c-muted">├─</span>
          <span className="c-nerd"> {"\u{F1044}"} Node v24.2.0</span>
        </div>
        <div>
          <span className="c-muted">|</span>
        </div>
...
export const PS1_CODE:Record<string, string> = {
